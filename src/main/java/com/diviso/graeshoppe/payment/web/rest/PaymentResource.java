...
public class PaymentResource {
    ...
    public ResponseEntity<PaymentDTO> createPayment(@RequestBody PaymentDTO paymentDTO) throws URISyntaxException {
        ...
        return ResponseEntity.created(new URI("/api/payments/" + result.getId()))
            .headers(HeaderUtil.createEntityCreationAlert("payment",true,ENTITY_NAME, result.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<PaymentDTO> updatePayment(@RequestBody PaymentDTO paymentDTO) throws URISyntaxException {
        ...
        return ResponseEntity.ok()
            .headers(HeaderUtil.createEntityUpdateAlert("payment",true,ENTITY_NAME, paymentDTO.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<Void> deletePayment(@PathVariable Long id) {
        ...
        return ResponseEntity.ok().headers(HeaderUtil.createEntityDeletionAlert("payment",true,ENTITY_NAME, id.toString())).build();
    }
